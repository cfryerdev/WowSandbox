...
<Fragment>
  <div className="card" style={blogCard}>
    <div className="card-body">
      <h4 className="card-title">Project Board Created</h4>
      ...
      <a target="_blank" rel="noopener noreferrer" href="https://github.com/cfryerdev/wuncraft/projects/1" className="card-link">Visit Board</a>
    </div>
  </div>

  <div className="card" style={blogCard}>
    <div className="card-body">
      <h4 className="card-title">Repository Created</h4>
      <h6 className="card-subtitle mb-2 text-muted">June 30th 2018</h6>
      <p className="card-text">
      ...
      <a target="_blank" rel="noopener noreferrer" href="https://github.com/cfryerdev/wuncraft" className="card-link">Visit GitHub</a>
    </div>
  </div>

  <div className="card" style={blogCard}>
    <div className="card-body">
      <h4 className="card-title">Project Created...</h4>
      <h6 className="card-subtitle mb-2 text-muted">June 30th 2018</h6>
      <p className="card-text">
